...
_STRINGS: dict[str, dict[Lang, str]] = {
    ...
    "nav_utenti": {"it": "Utenti web", "fr": "Utilisateurs web", "en": "Web users"},
    ...
    "utenti_subtitle": {
        "it": "Account con accesso alla dashboard web (admin e contabile)",
        "fr": "Comptes avec accès au tableau de bord web (admin et comptable)",
        "en": "Accounts with access to the web dashboard (admin and accountant)",
    },
    "utenti_new": {"it": "Nuovo utente", "fr": "Nouvel utilisateur", "en": "New user"},
    "utenti_list": {"it": "Utenti registrati", "fr": "Utilisateurs enregistrés", "en": "Registered users"},
    "utenti_save": {"it": "Crea utente", "fr": "Créer l'utilisateur", "en": "Create user"},
    "utenti_you": {"it": "Tu", "fr": "Vous", "en": "You"},
    "utenti_no_users": {
        "it": "Nessun utente configurato",
        "fr": "Aucun utilisateur configuré",
        "en": "No users configured",
    },
    "col_role": {"it": "Ruolo", "fr": "Rôle", "en": "Role"},
    "col_created": {"it": "Creato il", "fr": "Créé le", "en": "Created"},
    "lbl_password": {"it": "Password", "fr": "Mot de passe", "en": "Password"},
    "lbl_password_new": {
        "it": "Nuova password",
    ...
    "msg_utente_added": {
        "it": "Utente creato correttamente.",
    ...
    "err_email_duplicate": {
        "it": "Email già registrata per un altro utente.",
        "fr": "E-mail déjà utilisée par un autre utilisateur.",
        "en": "Email already registered for another user.",
    },
    "err_email_empty": {
    ...
    "err_password_empty": {
        "it": "La password è obbligatoria per i nuovi utenti.",
        "fr": "Le mot de passe est obligatoire pour les nouveaux utilisateurs.",
    ...
    "err_ultimo_admin": {
        "it": "Deve restare almeno un amministratore.",
        "fr": "Il doit rester au moins un administrateur.",
        "en": "At least one administrator must remain.",
    },
    "err_delete_self": {
        "it": "Non puoi eliminare il tuo account mentre sei connesso.",
        "fr": "Vous ne pouvez pas supprimer votre propre compte connecté.",
        "en": "You cannot delete your own account while signed in.",
    },
    "utente_delete_confirm": {
        "it": "Eliminare l'utente {email}?",
        "fr": "Supprimer l'utilisateur {email} ?",
    ...
    "edit_utente_hint": {
        "it": "Lascia la password vuota se non vuoi modificarla.",
        "fr": "Laissez le mot de passe vide pour ne pas le modifier.",
        "en": "Leave the password blank if you do not want to change it.",
    },
